...
import { ConfigProvider, DatePicker, Empty, Form, Input, Pagination } from 'antd';
                    ...
                    <div className="grid grid-cols-1 gap-[30px] ">
                      {paginatedJobs.map(job => (
                        <div
                          ...
                          <Link href={`/portal/workshops/${job.id}`} className="blog__img flex-shrink-0 rounded-md group-hover:bg-primary-white">
                            <ImageComponent
                              src={job.company.logoUrl || '/images/user-default.png'}
                              alt={job.company.companyName}
                              className="aspect-square max-h-[240px] w-full overflow-hidden rounded-[10px] object-contain"
                            />
                          </Link>
                          <div className="flex w-full flex-col">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="absolute bottom-[30px] right-[24px] flex items-center justify-end ">
                                <Link href={`/portal/workshops/${job.id}`} className="readmore__btn mf-2 mr-2 flex items-center gap-2 text-lg">
