    ...
    <div className="rts__section relative min-h-[450px] bg-breakcrumb-bg bg-cover bg-no-repeat">
      <div className="container mx-auto lg:px-[80px]">
        <div className=" w-full">
          <div className="z-[2] flex w-full flex-col  items-center justify-between gap-10 pb-[130px] pt-[210px] sm:items-start lg:flex-row lg:items-center lg:gap-0 ">
            <div className="z-50 flex w-full flex-col items-center gap-[30px] sm:flex-row">
              ...
              <div className="max-w-[90%] text-center sm:max-w-[70%] sm:text-left">
