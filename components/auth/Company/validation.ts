...
const validationSchema = Yup.object({
  company_name: Yup.string().required('Tên doanh nghiệp không được bỏ trống').max(50, 'Tên doanh nghiệp không được quá 50 kí tự'),
  company_code: Yup.string().required('Mã doanh nghiệp không được bỏ trống').max(30, 'Mã doanh nghiệp không được quá 30 kí tự'),
  email: Yup.string()
  ...
  company_description: Yup.string().required('Mô tả không được bỏ trống'),
  ...
  tax_code: Yup.string().required('Mã số thuế không được bỏ trống').max(30, 'Mã số thuế không được quá 30 kí tự'),
});
