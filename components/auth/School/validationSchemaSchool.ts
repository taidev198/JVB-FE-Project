...
const validationSchemaSchool = Yup.object({
  university_name: Yup.string().required('Tên trường học là bắt buộc').max(50, 'Tên trường học không được quá 50 kí tự'),
  university_code: Yup.string().required('Mã trường học là bắt buộc').max(30, 'Mã trường học không được quá 30 kí tự'),
  email: Yup.string()
  ...
  university_description: Yup.string().required('Mô tả là bắt buộc'),
  ...
  type_university: Yup.string().required('Loại trường là bắt buộc'),
});
