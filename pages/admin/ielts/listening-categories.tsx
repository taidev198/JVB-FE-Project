...
import { Card, Typography, Progress, Space, Spin, Button } from 'antd';
...
const IeltsCategoriesPage: React.FC = () => {
  ...
  const handleViewAllPractices = () => {
    router.push('/listening-practices');
  };
    ...
    <Container>
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4">
          <Title level={2} className="text-center mb-4">IELTS Speaking Categories</Title>
          ...
          <div className="text-center mb-8">
            <Button 
              ...
              onClick={handleViewAllPractices}
              className="mb-4"
            >
              View All Listening Practices
            </Button>
            <Text className="block text-gray-600">
              Browse all practices across all categories
            </Text>
          </div>
